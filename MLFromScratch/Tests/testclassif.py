...
try:
    ...
    testIris = testBase(datasets.load_iris)
    testDigits = testBase(datasets.load_digits)
    testOlivetti = testBase(datasets.fetch_olivetti_faces)
    testBreast = testBase(datasets.load_breast_cancer)
except ImportError:
