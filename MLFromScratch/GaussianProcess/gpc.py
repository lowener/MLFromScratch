...
class GaussianProcessClassificator(AlgorithmBase):
    """
    References:
        ...
        Pattern Recognition and Machine Learning, Section 6.4.2, Page 306
        https://www.youtube.com/watch?v=R-NUdqxKjos

    """

    def __init__(self, kernel, alpha=1e-8):
        self.kernel = kernel
        self.alpha = alpha
...
if __name__ == "__main__":
    ...
    # algo = GaussianProcessClassificator(kernel=kernel, alpha=0)
